...
{
    public const string ProjectName = "wearandtear";
...
public sealed class PackageTask : FrostingTask<BuildContext>
{
    public override void Run(BuildContext context)
    {
        ...
        context.CopyDirectory($"../{BuildContext.ProjectName}/bin/{context.BuildConfiguration}/Mods/mod/publish", $"../Releases/{context.Name}");
