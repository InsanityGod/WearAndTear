...
public static class DurabilityCommands
{
    ...
    public static TextCommandResult SetDurability(
        [CommandParameter(ContextualSource = EContextualSource.CallerTarget)][Required(ErrorMessage = Constants.TARGET_NOT_WEARANDTEAR_AFFECTED)] PartController controller,
    ...
    [AutoCommand(Path = "wearandtear", RequiredPrivelege = "controlserver")]
    public static TextCommandResult RemoveAttributes([CommandParameter(ContextualSource = EContextualSource.Caller)] ItemSlot itemslot)
    {
