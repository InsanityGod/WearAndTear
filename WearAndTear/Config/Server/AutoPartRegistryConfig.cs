...
{
    [AutoConfig("WearAndTear/Server/AutoPartRegistryConfig.json", ServerSync = true)]
    public static AutoPartRegistryConfig Instance { get; internal set; }
    ...
    /// </summary>
    public Dictionary<EnumBlockMaterial, PartProps> DefaultFrameProps { get; set; } = new()
    {
        {
    ...
    /// </summary>
    public Dictionary<EnumBlockMaterial, ProtectiveTemplate[]> DefaultProtectivePartProps { get; set; } = new()
    {
        {
            EnumBlockMaterial.Wood,
            new ProtectiveTemplate[]
            {
                new()
                {
                    PartProps = new()
                    ...
                    ProtectiveProps = new()
                    {
                        EffectiveFor = new ProtectiveTargetProps[]
                        {
                            new()
                            {
                                RepairType = "wood"
    ...
    /// </summary>
    public ProtectiveTemplate MetalReinforcementTemplate { get; set; } = new()
    {
        PartProps = new()
        {
        ...
        ProtectiveProps = new ProtectivePartProps
        {
            EffectiveFor = new ProtectiveTargetProps[]
            {
                new()
    ...
    /// </summary>
    public Dictionary<string, ReinforcementTemplate> MetalConfig { get; set; } = new()
    {
        {
            "default",
            new()
